...
<html>
    ...
    <body class="background">
        <!--Putting video as a background-->
        <!--Put controls muted and the video will play silently-->
        <video autoplay loop poster="yee.png" id="bgvid">
            <source src="images/yee.mp4" type="video/mp4">
        </video>
        <!--Makes the title-->
